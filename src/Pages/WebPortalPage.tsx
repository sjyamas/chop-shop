...
const data2 = [
  ...
  { enable: true, sender: false, x: -17, y: 60, z: -990, name: "Villageville" },
  { enable: true, sender: true, x: 0, y: 74, z: -122, name: "Villageville" },
  {
    enable: true,
    sender: false,
    x: 232,
  ...
  { enable: true, sender: true, x: 31, y: 74, z: -160, name: "Highland Park" },
  { enable: true, sender: false, x: 292, y: 136, z: -1261, name: "Roof" },
  { enable: true, sender: true, x: 37, y: 129, z: -157, name: "Roof" },
  { enable: true, sender: false, x: -1210, y: 70, z: -252, name: "Desert" },
  { enable: true, sender: true, x: -149, y: 91, z: -38, name: "Desert" },
  { enable: true, sender: false, x: -668, y: -43, z: -1796, name: "End" },
  { enable: true, sender: true, x: -96, y: 53, z: -234, name: "End" },
  { enable: true, sender: false, x: 952, y: 63, z: -1276, name: "Iron Farm" },
  { enable: true, sender: true, x: 118, y: 120, z: -159, name: "Iron Farm" },
  { enable: true, sender: false, x: 201, y: 80, z: -604, name: "Mesa" },
  { enable: true, sender: true, x: 25, y: 75, z: -75, name: "Mesa" },
  { enable: true, sender: false, x: 789, y: 64, z: -240, name: "Warm Ocean" },
  { enable: true, sender: true, x: 98, y: 37, z: -30, name: "Warm Ocean" },
  { enable: true, sender: false, x: -2099, y: 66, z: -2528, name: "Swamp" },
  { enable: true, sender: true, x: -262, y: 128, z: -317, name: "Swamp" },
  {
    enable: true,
    sender: false,
    x: -6124,
  ...
  { enable: true, sender: true, x: 149, y: 90, z: -152, name: "Golem Grinder" },
  {
    enable: true,
    sender: false,
    x: -3594,
  ...
  { enable: true, sender: true, x: -442, y: 121, z: -154, name: "Cold Biomes" },
];
